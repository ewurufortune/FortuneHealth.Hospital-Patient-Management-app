...
const postTypes = [
  { label: "Most Liked Entries", value: "mostLikedPosts" },
  { label: "Recently Liked Entries", value: "recentlyLikedPosts" },
  { label: "Recent Entries", value: "recentPosts" },
];
  ...
  const viewOtherPosts = [
    {
      ...
      children: (
        <>
          ...
          >
          {contextHolder}
            <Button onClick={handlePublishUpdate}>Publish My Database</Button>
          </div>
        </>
      ),
    },
        ...
        <div>
          ...
          <div style={{ marginTop: 16 }}>
            ...
            >
              ...
              <Select.Option value={true}>Admitted</Select.Option>
              <Select.Option value={false}>Not Admitted</Select.Option>
            </Select>
